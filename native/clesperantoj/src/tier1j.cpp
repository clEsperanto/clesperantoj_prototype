...
ArrayJ Tier1::unpad_func(DeviceJ * device, ArrayJ * src, ArrayJ * dst, int size_x, int size_y, int size_z, bool center)
{
    return ArrayJ{cle::tier1::unpad_func_func(device->get(), src->get(), dst == nullptr ? nullptr : dst->get(), size_x, size_y, size_z, center)};
}
