...
public class Tier2 {
	 ...
	 * With the offset you have control which slices stays: with a factor 3 and offset 0, slices 0,3,6, etc.
	 * are kept.
	 * with a factor 4 and offset 1, slices 1,5,9, etc.
	 * are kept.
	 * @param device ({@link DeviceJ}) - Device to perform the operation on.
	 * @param input ({@link ArrayJ}) - Input image.
	 * @param output ({@link ArrayJ}) - Output image. (default: None)
	 ...
	 * The radius parameter control the local variance calculation, and the sigma apply a gaussian blur for smoothness of the projection.
	 * @param device ({@link DeviceJ}) - Device to perform the operation on.
	 * @param input ({@link ArrayJ}) - Input image to process.
	 * @param output ({@link ArrayJ}) - Output result image. (default: None)
	 * @param radius_x (float) - Sphere radius filter in x axis. (default: 10)
	 * @param radius_y (float) - Sphere radius filter in y axis. (default: 10)
	 ...
	 * The function return the list of eigenvalues as images, by decreasing order.
