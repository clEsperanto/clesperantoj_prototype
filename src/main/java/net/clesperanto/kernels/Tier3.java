...
public class Tier3 {
	 ...
	 * @param tile_size (int) - Size of the tiles to be used for CLAHE. (default: 8)
	 ...
	 * @param minimum_intensity (float) -  (default: float('nan'))
	 * @param maximum_intensity (float) -  (default: float('nan'))
	 * @return {@link ArrayJ}
	 ...
	 * in 1998 (https://doi.
	 * org/10.
	 * 1016/S1361-8415(98)80009-1) The filter will cumulate the maximum response over a range of [sigma_minimum, sigma_maximum[.
	 * @param device ({@link DeviceJ}) - Device to perform the operation on.
	 * @param input ({@link ArrayJ}) - Input image to process.
	 * @param output ({@link ArrayJ}) - Output result image. (default: None)
	...
	/**
	 * Enhances filamentous structures of a specified thickness in 2D or 3D This function is a reimplementation of the Tubeness filter from Fiji/ImageJ It is based on the Sato filter (https://doi.
	 * org/10.
