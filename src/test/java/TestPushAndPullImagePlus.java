...
public class TestPushAndPullImagePlus {
	...
	public void testImagePlusPushAndPullFloat() {
		...
		ArrayJ in = ImageJConverters.copyImagePlus2ToArrayJ(inputImp, device,
				"buffer");
	...
	// for (int y = 0; y < 3; y++) {
	// for (int x = 0; x < 3; x++) {
	// inpIp.putPixelValue(x, y, flatVals[c] < 0 ? MAX_UINT16 + flatVals[c] :
	// flatVals[c]);
	// c++;
	// }
	// }
	...
	// for (int y = 0; y < 3; y++) {
	// for (int x = 0; x < 3; x++) {
	// inpIp.putPixelValue(x, y, flatVals[c] < 0 ? MAX_UINT8 + flatVals[c] :
	// flatVals[c]);
	// c++;
	// }
	// }
